"""
This file is sourced from davidtvs.  We hereby thank the authors of this code.

Project Source: PyTorch-ENet
https://github.com/davidtvs/PyTorch-ENet/blob/master/transforms.py

License (MIT):
https://github.com/davidtvs/PyTorch-ENet/blob/master/LICENSE
"""
